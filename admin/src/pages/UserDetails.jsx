      ...
      <div className="col-xl-4">
        <div className="card">
          <div className="card-body profile-card pt-4 d-flex flex-column align-items-center">
            <img
              src={`${apiUrl}/uploads/${userDetails.photo}`}
              alt="Profile"
            ...
            <div className="tab-content pt-2">
              ...
              >
                ...
                <div className="row">
                  ...
                  <div className="col-lg-9 col-md-8">{userDetails.name}</div>
                </div>
                {/* <div className="row">
                ...
                <div className="row">
                  <div className="col-lg-3 col-md-4 label">Profile Password</div>
                  <div className="col-lg-9 col-md-8">
                    {userDetails.profile_password}
                  </div>
                </div>
                <div className="row">
                  <div className="col-lg-3 col-md-4 label">Phone</div>
                  <div className="col-lg-9 col-md-8">{userDetails.contact}</div>
                </div>
                <div className="row">
                  <div className="col-lg-3 col-md-4 label">Email</div>
                  <div className="col-lg-9 col-md-8">
